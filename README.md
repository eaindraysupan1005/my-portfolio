# Eaindray Su Pan - Personal Portfolio

A modern, responsive personal portfolio website built with React, Vite, and Tailwind CSS. 
It showcases my projects, skills, experience, and provides a way to get in touch.

## 🚀 Features

- **Modern UI/UX**: Clean, glassmorphism-inspired design with smooth animations.
- **Fully Responsive**: Optimized for both desktop and mobile devices.
- **Dynamic Projects Section**: Detailed modal views for project features and tech stack.
- **Interactive Contact Form**: Integrated with EmailJS for direct messaging.
