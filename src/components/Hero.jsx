...
export default function Hero() {
    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-grid">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center gap-10 lg:gap-16 pt-20 pb-10 lg:pt-0 lg:pb-0">
                {/* Left - Text Content */}
                <div className={`flex-1 text-center lg:text-left transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-accent/30 bg-accent/5 text-accent text-sm font-medium mb-6">
                    ...
                    <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                        ...
                        <a
                            href="#contact"
                            className="px-8 py-3 rounded-xl border border-primary/40 text-textColor font-semibold text-sm hover:bg-primary/10 hover:border-primary hover:-translate-y-0.5 transition-all duration-200"
                        >
                            Contact Me
                        </a>
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="px-8 py-3 rounded-xl border border-white/40 text-white font-semibold text-sm hover:border-white hover:bg-white/10 hover:-translate-y-0.5 transition-all duration-200 flex items-center gap-2"
                        >
                ...
                <div className={`flex-shrink-0 transition-all duration-700 delay-200 order-first lg:order-last ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    <div className="relative animate-float">
                        ...
                        <div className="absolute -bottom-3 -left-3 sm:-bottom-4 sm:-left-4 glass rounded-xl px-2 py-1 sm:px-3 sm:py-2 text-xs font-semibold text-primary border border-primary/20 shadow-lg whitespace-nowrap">
                            <span>🚀 Dev</span>
                        </div>
                    </div>
                </div>
